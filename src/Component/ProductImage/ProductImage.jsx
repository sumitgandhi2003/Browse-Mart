...
const ProductImage = ({ productData }) => {
  ...
  return (
    <div className="img-container flex gap-4 m-4 p-4 w-2/3 mobile:w-full tablet:w-1/2 mobile:m-0 max-h-[500px] mobile:flex-col-reverse mobile:items-center small-device:flex-row  tablet:flex-row">
      <div className="flex flex-col  gap-2 overflow-scroll  items-center min-h-[400px]  min-w-[70px] max-h-[450px] mobile:flex-row mobile:min-h-0  mobile:overflow-scroll mobile:w-full small-device:w-max small-device:min-h-[400px] small-device:flex-col tablet:flex-col ">
